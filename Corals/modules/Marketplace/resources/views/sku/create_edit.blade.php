                    ...
                    <div class="col-md-4">
                        ...
                        @if($product->shipping['enabled'])
                            <div class="row" id="shipping">
                                <div class="col-md-3">
                                    {!! CoralsForm::number('shipping[width]','Marketplace::attributes.sku.width',true,$sku->shipping['width'] ?? data_get($product,'shipping.width')  ,['help_text'=>\Settings::get('marketplace_shipping_dimensions_unit','inch'),'min'=>0]) !!}
                                </div>
                                <div class="col-md-3">
                                    {!! CoralsForm::number('shipping[height]','Marketplace::attributes.sku.height',true,$sku->shipping['height']?? data_get($product,'shipping.height') ,['help_text'=>\Settings::get('marketplace_shipping_dimensions_unit','inch'),'min'=>0]) !!}
                                </div>
                                <div class="col-md-3">
                                    {!! CoralsForm::number('shipping[length]','Marketplace::attributes.sku.length',true,$sku->shipping['length']?? data_get($product,'shipping.length'),['help_text'=>\Settings::get('marketplace_shipping_dimensions_unit','inch'),'min'=>0]) !!}
                                </div>
                                <div class="col-md-3">
                                    {!! CoralsForm::number('shipping[weight]','Marketplace::attributes.sku.weight',true,$sku->shipping['weight']?? data_get($product,'shipping.weight'),['help_text'=>\Settings::get('marketplace_shipping_weight_unit','ounce'),'min'=>0]) !!}
                                </div>
                            </div>
                        @endif
                    </div>
